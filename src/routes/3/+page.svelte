<script lang="ts">
	import {phrases, correctPhrases, correctPhrase3, phrase3} from '../phrases.js'
	...
	let randomPhrase = phrase3.join(' ')

	let correctPhrase = correctPhrase3
	...
	<div class="header">
		<span class="tooltip">
			<span aria-current={$page.url.pathname === '/2' ? 'page' : undefined}>
				<a href="/2"><span class="material-symbols-outlined">arrow_back_ios</span></a>
			</span>
		...
		<span class="tooltip">
			<span aria-current={$page.url.pathname === '/1' ? 'page' : undefined}>
				<a href="/1"><span class="material-symbols-outlined">arrow_forward_ios</span></a>
			</span>
